...
- **In-game panels scaled** (v0.1.10): inventory, character, spell book and specialties panels are scaled with the menus, item grids included. Drag and drop, hover and re-equip all work at the scaled size.
...
- The item icon held on the cursor while dragging draws at the original size (cosmetic).
- The Journal cloth map renders at its native size.
